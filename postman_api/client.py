...
class PostmanClient:
    ...
    def get_all_apis(
        ...
        *,
        ...
        text = self.send("GET", self.base_url + "/apis", headers, params, data)
    ...
    def create_api(
        ...
        text = self.send("POST", self.base_url + "/apis", headers, params, data)
        return json.loads(text)

    def single_api(self, api_id: str) -> Any:
        """Get an API
        ...
        text = self.send(
            "GET", self.base_url + f"/apis/{api_id}", headers, params, data
        )
        return json.loads(text)

    def update_an_api(self, api_id: str, *, api: Optional[Any] = None) -> Any:
        """Update an API
        ...
        text = self.send(
            "PUT", self.base_url + f"/apis/{api_id}", headers, params, data
        )
        return json.loads(text)

    def delete_an_api(self, api_id: str) -> Any:
        """Delete an API
        ...
        text = self.send(
            "DELETE", self.base_url + f"/apis/{api_id}", headers, params, data
        )
        return json.loads(text)

    def get_all_api_versions(self, api_id: str) -> Any:
        ...
        text = self.send(
            "GET", self.base_url + f"/apis/{api_id}/versions", headers, params, data
        )
        return json.loads(text)

    def create_api_version(self, api_id: str, *, version: Optional[Any] = None) -> Any:
        ...
        text = self.send(
            "POST", self.base_url + f"/apis/{api_id}/versions", headers, params, data
        )
        return json.loads(text)

    def get_an_api_version(self, api_id: str, api_version_id: str) -> Any:
        """Get an API version
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}",
            headers,
            params,
            data,
        )
    ...
    def delete_an_api_version(self, api_id: str, api_version_id: str) -> Any:
    ...
    def get_contract_test_relations(self, api_id: str, api_version_id: str) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/contracttest",
            headers,
            params,
            data,
        )
    ...
    def get_documentation_relations(self, api_id: str, api_version_id: str) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/documentation",
            headers,
            params,
            data,
        )
    ...
    def get_environment_relations(self, api_id: str, api_version_id: str) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/environment",
            headers,
            params,
            data,
        )
    ...
    def get_integration_test_relations(self, api_id: str, api_version_id: str) -> Any:
    ...
    def get_mock_server_relations(self, api_id: str, api_version_id: str) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/mock",
            headers,
            params,
            data,
        )
    ...
    def get_monitor_relations(self, api_id: str, api_version_id: str) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/monitor",
            headers,
            params,
            data,
        )
    ...
    def get_linked_relations(self, api_id: str, api_version_id: str) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/relations",
            headers,
            params,
            data,
        )
    ...
    def create_schema(
        ...
        text = self.send(
            "POST",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/schemas",
            headers,
            params,
            data,
        )
    ...
    def get_schema(self, api_id: str, api_version_id: str, schema_id: str) -> Any:
        """Get a schema
    ...
    def get_test_relations(self, api_id: str, api_version_id: str) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/test",
            headers,
            params,
            data,
        )
    ...
    def get_test_suite_relations(self, api_id: str, api_version_id: str) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + f"/apis/{api_id}/versions/{api_version_id}/testsuite",
            headers,
            params,
            data,
        )
    ...
    def all_collections(self, *, workspace_id: Optional[str] = None) -> Any:
        """Get all collections
        ...
        text = self.send("GET", self.base_url + "/collections", headers, params, data)
        return json.loads(text)
    ...
    def create_collection(
        ...
        **Note:**
        ...
        text = self.send("POST", self.base_url + "/collections", headers, params, data)
        return json.loads(text)
    ...
    def create_a_fork(
        ...
        text = self.send(
            "POST",
            self.base_url + f"/collections/fork/{collection_uid}",
            headers,
            params,
            data,
        )
    ...
    def merge_a_fork(
        ...
        *,
        ...
        text = self.send(
            "POST", self.base_url + "/collections/merge", headers, params, data
        )
        return json.loads(text)

    def single_collection(self, collection_uid: str) -> Any:
        """Get a collection
        ...
        text = self.send(
            "GET",
            self.base_url + f"/collections/{collection_uid}",
            headers,
            params,
            data,
        )
    ...
    def delete_collection(self, collection_uid: str) -> Any:
        """Delete a collection
    ...
    def all_environments(self, *, workspace_id: Optional[str] = None) -> Any:
        ...
        text = self.send("GET", self.base_url + "/environments", headers, params, data)
        return json.loads(text)
    ...
    def create_environment(
        ...
        text = self.send("POST", self.base_url + "/environments", headers, params, data)
        return json.loads(text)

    def single_environment(self, environment_uid: str) -> Any:
        """Get an environment
        ...
        text = self.send(
            "GET",
            self.base_url + f"/environments/{environment_uid}",
            headers,
            params,
            data,
        )
    ...
    def delete_environment(self, environment_uid: str) -> Any:
    ...
    def import_exported_data(self) -> Any:
        ...
        **This endpoint is deprecated.**
        ...
        text = self.send(
            "POST", self.base_url + "/import/exported", headers, params, data
        )
        return json.loads(text)

    def import_external_api_specification(
        ...
        text = self.send(
            "POST", self.base_url + "/import/openapi", headers, params, data
        )
        return json.loads(text)

    def api_key_owner(self) -> Any:
        ...
        text = self.send("GET", self.base_url + "/me", headers, params, data)
        return json.loads(text)

    def all_mocks(self) -> Any:
        ...
        text = self.send("GET", self.base_url + "/mocks", headers, params, data)
        return json.loads(text)
    ...
    def create_mock(
        ...
        text = self.send("POST", self.base_url + "/mocks", headers, params, data)
        return json.loads(text)

    def single_mock(self, mock_uid: str) -> Any:
        """Get a mock server
        ...
        text = self.send(
            "GET", self.base_url + f"/mocks/{mock_uid}", headers, params, data
        )
        return json.loads(text)

    def update_mock(self, mock_uid: str, *, mock: Optional[Any] = None) -> Any:
        ...
        text = self.send(
            "PUT", self.base_url + f"/mocks/{mock_uid}", headers, params, data
        )
        return json.loads(text)

    def delete_mock(self, mock_uid: str) -> Any:
        ...
        text = self.send(
            "DELETE", self.base_url + f"/mocks/{mock_uid}", headers, params, data
        )
        return json.loads(text)

    def publish_mock(self, mock_uid: str) -> Any:
        ...
        text = self.send(
            "POST", self.base_url + f"/mocks/{mock_uid}/publish", headers, params, data
        )
        return json.loads(text)

    def unpublish_mock(self, mock_uid: str) -> Any:
        ...
        text = self.send(
            "DELETE",
            self.base_url + f"/mocks/{mock_uid}/unpublish",
            headers,
            params,
            data,
        )
    ...
    def all_monitors(self) -> Any:
        ...
        text = self.send("GET", self.base_url + "/monitors", headers, params, data)
        return json.loads(text)
    ...
    def create_monitor(
        ...
        text = self.send("POST", self.base_url + "/monitors", headers, params, data)
        return json.loads(text)

    def single_monitor(self, monitor_uid: str) -> Any:
        """Get a monitor
        ...
        text = self.send(
            "GET", self.base_url + f"/monitors/{monitor_uid}", headers, params, data
        )
        return json.loads(text)

    def update_monitor(self, monitor_uid: str, *, monitor: Optional[Any] = None) -> Any:
        """Update a monitor
        ...
        text = self.send(
            "PUT", self.base_url + f"/monitors/{monitor_uid}", headers, params, data
        )
        return json.loads(text)

    def delete_monitor(self, monitor_uid: str) -> Any:
        """Delete a monitor
        ...
        text = self.send(
            "DELETE", self.base_url + f"/monitors/{monitor_uid}", headers, params, data
        )
        return json.loads(text)

    def run_a_monitor(self, monitor_uid: str) -> Any:
        """Run a monitor
        ...
        text = self.send(
            "POST",
            self.base_url + f"/monitors/{monitor_uid}/run",
            headers,
            params,
            data,
        )
    ...
    def get_resource_types(self) -> List[Any]:
        """Get resource types
        ...
        text = self.send(
            "GET", self.base_url + "/scim/v2/ResourceTypes", headers, params, data
        )
        return List[Any].parse_raw(text)

    def service_provider_config(self) -> Any:
        ...
        text = self.send(
            "GET",
            self.base_url + "/scim/v2/ServiceProviderConfig",
            headers,
            params,
            data,
        )
    ...
    def fetch_all_user_resource(
        ...
        *,
        ...
        text = self.send("GET", self.base_url + "/scim/v2/Users", headers, params, data)
        return json.loads(text)
    ...
    def create_user(
        ...
        *,
        ...
        text = self.send(
            "POST", self.base_url + "/scim/v2/Users", headers, params, data
        )
        return json.loads(text)

    def fetch_user_resource(self, user_id: str) -> Any:
        """Get user resource
        ...
        text = self.send(
            "GET", self.base_url + f"/scim/v2/Users/{user_id}", headers, params, data
        )
        return json.loads(text)
    ...
    def update_user_information(
        ...
        **Note:**
        ...
        text = self.send(
            "PUT", self.base_url + f"/scim/v2/Users/{user_id}", headers, params, data
        )
        return json.loads(text)
    ...
    def update_user_state(
        ...
        *,
        ...
        text = self.send(
            "PATCH", self.base_url + f"/scim/v2/Users/{user_id}", headers, params, data
        )
        return json.loads(text)

    def schema_security_validation(self, *, schema: Optional[Any] = None) -> Any:
        ...
        **Note:**
        ...
        text = self.send(
            "POST", self.base_url + "/security/api-validation", headers, params, data
        )
        return json.loads(text)
    ...
    def create_webhook(
        ...
        text = self.send("POST", self.base_url + "/webhooks", headers, params, data)
        return json.loads(text)

    def all_workspaces(self, *, type: Optional[str] = None) -> Any:
        """Get all workspaces
        ...
        **Note:**
        ...
        text = self.send("GET", self.base_url + "/workspaces", headers, params, data)
        return json.loads(text)

    def create_workspace(self, *, workspace: Optional[Any] = None) -> Any:
        """Create a workspace
        ...
        text = self.send("POST", self.base_url + "/workspaces", headers, params, data)
        return json.loads(text)

    def single_workspace(self, workspace_id: str) -> Any:
        """Get a workspace
        ...
        **Note:**
        ...
        text = self.send(
            "GET", self.base_url + f"/workspaces/{workspace_id}", headers, params, data
        )
        return json.loads(text)
    ...
    def update_workspace(
        ...
        **Note:**
        ...
        text = self.send(
            "PUT", self.base_url + f"/workspaces/{workspace_id}", headers, params, data
        )
        return json.loads(text)
